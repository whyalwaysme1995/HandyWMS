...
using HandyWMS_ClassLibrary.Params;
using HandyWMS_ClassLibrary.Utils;
using HandyWMS_Server.Bussiness.DepartmentBusiness;
...
namespace HandyWMS_Server.Bussiness.UserBusiness
{
    public class UserBLL
    {
                        ...
                        switch (platform)
                        {
                            case (int)PlatformEnum.Web:
                                if (GlobalContext.SystemConfig.LoginMultiple)
                                {
                                    ...
                                    {
                                        user.WebToken = SecurityUtil.GetGuid(true);
                                    }
                                    #endregion
                                }
                                else
                            ...
                            case (int)PlatformEnum.WebApi:
                                user.ApiToken = SecurityUtil.GetGuid(true);
                                break;
                        }
        ...
        {
            string md5Password = SecurityUtil.MD5ToHex(password);
            string encryptPassword = SecurityUtil.MD5ToHex(md5Password.ToLower() + salt).ToLower();
