...
using HandyWMS_ClassLibrary.Utils.SecurityUtils;

namespace HandyWMS_Server.Utils.SecurityUtils
{
    public class SecurityUtil
    {
        ...
        public static string MD5ToHex(string input, int bit = 32)
        {
            ...
            string result = EncodingUtil.ByteArrToHexDefault(byteArr);
            if (bit == 16)
            {
        ...
        public static string AESEncryptToHex(string input, string key = "", string iv = "")
        {
            ...
            if (byteArr != null)
            {
                return EncodingUtil.ByteArrToHexDefault(byteArr);
            }
            return string.Empty;
        }
        ...
        {
            var byteArr = EncodingUtil.HexToByteArrDefault(cipherText);
            return AESDecrypt(byteArr, key, iv);
        }
        ...
        public static string HMAC_SHA256ToHex(string encrypt, string key = "")
        {
            ...
            return EncodingUtil.ByteArrToHexDefault(hash);
        }
