using HandyWMS_ClassLibrary.Utils.DateUtils;
using System;
...
namespace HandyWMS_ClassLibrary.Utils.IdUtils
{
    public class Snowflake
    {
        ...
        public long NextId()
        {
            lock (_lock)
            {
                var timestamp = DateTimeUtil.GetUnixTimeStamp(DateTime.Now);
        ...
        private long TilNextMillis(long lastTimestamp)
        {
            ...
            {
                timestamp = DateTimeUtil.GetUnixTimeStamp(DateTime.Now);
            }
            return timestamp;
        }
    }
